...
class CommunicationPhonenumberScenarios(ScenarioTest):
    ...
    def test_list_phonenumbers(self, communication_resource_info):
        ...
        phonenumber_list = self.cmd('az communication phonenumbers list-phonenumbers').get_output_in_json()
    ...
    def test_show_phonenumbers(self, communication_resource_info):
        ...
        phonenumber_info = self.cmd('az communication phonenumbers show-phonenumber --phonenumber \"{phonenumber}\"').get_output_in_json() 
